	...
	// Your code here.
        ...
        while (ebp!=0)
        {
 	      uint32_t* t;
              ...
              cprintf("eip %08x ",eip);
              cprintf("args");
 	      t = (uint32_t*)(ebp+8);  cprintf(" %08x",*t);
 	      t = (uint32_t*)(ebp+12); cprintf(" %08x",*t);
 	      t = (uint32_t*)(ebp+16); cprintf(" %08x",*t);
 	      t = (uint32_t*)(ebp+20); cprintf(" %08x",*t);
 	      t = (uint32_t*)(ebp+24); cprintf(" %08x\n",*t);
